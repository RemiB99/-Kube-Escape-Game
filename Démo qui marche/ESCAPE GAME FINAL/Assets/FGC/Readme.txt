...
4) For add hairs and cloths you can use add Item script; Use also alpha texture in FGC_Male_Char_Denzel.mat ad set rendering mode to "Cutout".
...
1.2
Grouped VIP Morph
Add 38 new Blendshapes
Add Body Morph Heavy
Add Prop Laser Gun

*******

1.1
Fit errors on Eyes meshes
All Joint Renamed
