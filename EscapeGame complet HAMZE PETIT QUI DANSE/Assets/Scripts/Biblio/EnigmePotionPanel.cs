...
public class EnigmePotionPanel : MonoBehaviour
{
    ...
    IEnumerator explicationsBouches(){
        ...
        bouche.GetComponent<Bouches>().setText("Bon, nous devons réaliser ce que ce client étrange nous demande..."
                                                +"Je me rappelle vaguement de la recette, alors écoutez moi !");
        yield return new WaitForSeconds(5);
        bouche.GetComponent<Bouches>().animBoucheReflechi();
        bouche.GetComponent<Bouches>().setText("Je serais votre chef, ne faites pas n'importe quoi"
                                                +"Ce serait bien dommage de decevoir notre client...");
        yield return new WaitForSeconds(5);
        bouche.GetComponent<Bouches>().animBoucheReflechi();
        bouche.GetComponent<Bouches>().setText("Alors, il faut d'abord utiliser cette potion violette"
                                                +"Ce sera notre composante de base");
        yield return new WaitForSeconds(5);
    }
    ...
    IEnumerator finPotion(){
        ...
        bouche.GetComponent<Bouches>().animBoucheContente();
        bouche.GetComponent<Bouches>().setText("Ca y'est ! Notre potion est finie ! Allons l'apporter au client !");
    ...
    public void majTextBouche(int posPotion){
        ...
        public void destroyPotions(){
            ...
            int[] idsPotions = new int[7];
            idsPotions[0]=1;idsPotions[1]=2;idsPotions[2]=3;idsPotions[3]=4;idsPotions[4]=5;idsPotions[5]=17;idsPotions[6]=18;
