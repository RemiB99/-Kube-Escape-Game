...
namespace Mirror
{
    ...
    public sealed class NetworkIdentity : MonoBehaviour
    {
        ...
        public ConnectionToClient clientAuthorityOwner => connectionToClient;
        ...
        private ConnectionToClient _connectionToClient;
        /// <summary>
        ...
        internal void SetClientOwner(NetworkConnection conn)
        {
            ...
            connectionToClient = (ConnectionToClient)conn;
        }
...
#pragma warning restore 618
        ...
        public void RemoveClientAuthority()
        {
            ...
            if (connectionToClient != null)
            {
                ...
                ConnectionToClient previousOwner = connectionToClient;
